...
export const HomeDashboard = () => {
  ...
  const bankThemeFor = (bankNameOrCode: string) => {
    const n = String(bankNameOrCode || "").trim().toLowerCase();
  ...
  return (
    <div className=" ">
      ...
      <div className="relative mb-3 overflow-hidden rounded-2xl p-[1px] shadow-lg ring-1 ring-white/10 [background:linear-gradient(135deg,var(--brand-600),var(--brand-700))]">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm">
          <div
            className="flex whitespace-nowrap py-2.5 text-white [will-change:transform]"
                ...
                {accounts.map((acc: any, idx: number) => {
                  ...
                  return (
                    <div
                      ...
                      data-acc-index={idx}
                      className="w-[22rem] sm:w-96"
                    >
                      <div
                        className="relative overflow-hidden rounded-2xl p-5 text-white shadow-lg ring-1 ring-white/10"
                        style={{
                        ...
                        <div className="relative">
                          <div className="flex itemes-center gap-3">
                            ...
                            <div className="grid h-8 w-8 place-items-center rounded-2xl bg-white/15 ring-1 ring-white/15">
                              {logo ? (
                                <Image src={logo} alt={acc.bankName} className="h-8 w-8" width={8} height={8} />
                              ) : (
                                <Image src="/images/logo.png" alt="Logo" className="h-8 w-8" width={15} height={15} />
                              )}
                            </div>
                          ...
                          <div className=" ">
                            ...
                            <div className="mt-1 truncate text-sm font-semibold text-white text-center">{acc.accountName}</div>
